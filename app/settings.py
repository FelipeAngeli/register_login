...
SECRET_KEY = 'django-insecure-$yg9dt4w_!^1zwn%^f)=k@fi7(8#a+0fu7l=%ei72%4alt+xjl'
...
# Diretório onde os arquivos estáticos estão localizados no projeto
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')  # Diretório onde os arquivos de mídis
